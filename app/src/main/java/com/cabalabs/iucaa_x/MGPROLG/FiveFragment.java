                ...
                for(int i=0; i<response.length(); i++){
                    ...
                    try{
                        ...
                        if(uid.equals(uidprev)) {
                            ...
                            Glide.with(com.cabalabs.iucaa_x.MGPROLG.FiveFragment.this).load(img1).transition(withCrossFade(1500)).into(imageView);
                            Glide.with(com.cabalabs.iucaa_x.MGPROLG.FiveFragment.this).load(img2).transition(withCrossFade(1500)).into(imageView1);
                            Glide.with(com.cabalabs.iucaa_x.MGPROLG.FiveFragment.this).load(img3).transition(withCrossFade(1500)).into(imageView2);
                            Glide.with(com.cabalabs.iucaa_x.MGPROLG.FiveFragment.this).load(img4).transition(withCrossFade(1500)).into(imageView3);
